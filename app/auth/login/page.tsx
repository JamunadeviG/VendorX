  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background-main px-4">
      <Card className="w-full max-w-md card-dark glow-effect">
        <CardHeader>
          <CardTitle className="text-text-primary text-2xl">Sign In</CardTitle>
        ...
        <CardContent>
          ...
          <div className="mt-4 text-center text-sm">
            ...
            <Link href="/auth/signup" className="text-primary-blue hover:text-secondary-blue transition-colors">
              Sign up
            </Link>
          </div>
        </CardContent>
