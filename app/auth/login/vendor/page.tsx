  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background-main px-4">
      <Card className="w-full max-w-md card-dark glow-effect">
        <CardHeader>
          <CardTitle className="text-text-primary text-2xl">Vendor Sign In</CardTitle>
          <CardDescription className="text-text-secondary">
            Sellers and farmers sign in here to manage products
          </CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <div className="mt-4 text-center text-sm">
            ...
            <Link href="/auth/login/buyer" className="text-primary-blue hover:text-secondary-blue transition-colors">
              Sign in here
            </Link>
          </div>
        </CardContent>
